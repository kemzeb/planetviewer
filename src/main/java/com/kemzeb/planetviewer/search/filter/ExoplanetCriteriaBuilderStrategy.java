...
public class ExoplanetCriteriaBuilderStrategy extends CriteriaBuilderStrategy {
  ...
  static {
    ...
    tempMap.put("discoveryMethod", Pair.of("discoveryMethod", String.class));
    tempMap.put("discoveryYear", Pair.of("discoveryYear", Integer.class));
  ...
  private Integer tryToParseInt(String value) {
    try {
      ...
      throw new ValidationException("Expected a given filter value to be a valid number.");
    }
  }
